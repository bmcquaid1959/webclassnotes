...
::: content-block
# Welcome to Quarto on Bob's website

<!-- this is a comment in R Markdown -->

<!--# This is another comment but includes a hashtag -->
...
::: hero-buttons
[Get Started](docs/get-started/){.btn-action-primary .btn-action .btn .btn-success .btn-lg role="button"} [Guide](docs/guide/){#btn-guide .btn-action .btn .btn-info .btn-lg role="button"}
:::
:::
